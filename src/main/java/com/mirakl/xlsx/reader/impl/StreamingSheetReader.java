...
import com.mirakl.xlsx.reader.SharedFormula;
...
import com.mirakl.xlsx.reader.exceptions.NotSupportedException;
import com.mirakl.xlsx.reader.exceptions.ParseException;
import com.mirakl.xlsx.reader.impl.ooxml.HyperlinkData;
...
public class StreamingSheetReader implements Iterable<Row> {
   ...
   * @throws IllegalStateException if {@link StreamingReader.Builder#setReadComments(boolean)} is not set to true
   */
   ...
   * @throws IllegalStateException if {@link StreamingReader.Builder#setReadHyperlinks(boolean)} is not set to true
   */
