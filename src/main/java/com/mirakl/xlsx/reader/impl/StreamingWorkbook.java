...
import com.mirakl.xlsx.reader.exceptions.MissingSheetException;
...
public class StreamingWorkbook implements Workbook, Date1904Support, AutoCloseable {
  ...
  /**
   * Returns the Core Properties if this feature is enabled on the {@link StreamingReader.Builder}
   *
   * @return CoreProperties
   * @throws IllegalStateException if {@link StreamingReader.Builder#setReadCoreProperties(boolean)} is not set to true
   */
